...
export default function DialogSelect({session, groupId}) {
  ...
  async function updateFilters() {
    ...
    const filters = [filterSettings[0], filterSettings[1], filterSettings[2], filterSettings[3], filterSettings[4]];
                ...
                <FormControl sx={{ m: 1 }} variant="standard">
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      value={filterSettings.firstDate|| ''}
                ...
                <FormControl sx={{ m: 1 }} variant="standard">
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      value={filterSettings.secondDate || ''}
